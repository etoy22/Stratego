...
public class StrategoClient {
   ...
   int team = 1; // Says what team you are on
   ...
   boolean rwin = false;
   boolean bwin = false;
   boolean rChoose = false;// the reds can choose
   boolean bChoose = true;// the blues can choose
   ...
   public StrategoClient() throws IOException {
   ...
   class Drawing extends JComponent// P4
   {
      ...
      public void paint(Graphics g) {
         ...
         if (screen == 0) {
            g.drawImage(ImageLoader.getLogo().getImage(), 115, 40, 750, 250, this);
         } else if (screen == 1) {
   ...
   public void multiGame() throws IOException {
      ...
      String s = JOptionPane.showInputDialog(
            "Enter Host Name (Must restart client and\nserver if entered incorrectly. CAPS MATTER!!!)");
      Socket sock;
