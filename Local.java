   ...
   class Drawing extends JComponent//P3
   {
      ...
      public void paint(Graphics g)
      {
         ...
         {  
            ...
            Font MonoFont = new Font("Monospaced",Font.BOLD,70);
            g.setFont(MonoFont);
            
            g.drawImage(logo.getImage(),160,40,750,250,this);
            ...
            MonoFont = new Font("Monospaced",Font.BOLD,50);
            g.setFont(MonoFont);
            ...
            MonoFont = new Font("Monospaced",Font.BOLD,20);
            g.setFont(MonoFont);
            g.setColor(Color.BLACK);
            g.drawString("-Game instructions (How to play and rules)can be found in the README Folder.",50,50);
            g.drawString("-In order to place a piece click its picture and then click the tile you want to place it on.",50,80);
               ...
               //Checks to see if the place they clicked where a peice is
                  ...
                  */
                     for (int r = 1; r < board.speed[xclick][yclick] + 1 && end == false &&  xclick + r < 10; r++)
                     {
                        ...
                        {
                           g.setColor(Color.green);
                           if (board.occupied[r+xclick][yclick] == true && board.rteam[xclick][yclick] != 11)
                           {
                              end = true;
                     ...
                     for (int r = 1; r < board.speed[xclick][yclick] + 1 && end == false && xclick - r >= 0; r++)
                     {
                        ...
                        else
                        {
                           ...
                           g.setColor(Color.green);
                           if (board.occupied[xclick-r][yclick] == true  && board.rteam[xclick][yclick] != 11)
                           {
                              end = true;
                              g.setColor(Color.orange);
                           }
                     ...
                     for (int r = 1; r < board.speed[xclick][yclick] + 1 &&  end == false && yclick - r >= 0; r++)
                     {
                        ...
                        {
                           g.setColor(Color.green);
                           if (board.occupied[xclick][yclick-r] == true  && board.rteam[xclick][yclick] != 11)
                           {
                              end = true;
                              g.setColor(Color.orange);
                           }
               ...
               else if (team == 1 && turn == 1)
               {
                  ...
                  */
                     for (int r = 1; r < board.speed[xclick][yclick] + 1 && end == false &&  xclick + r < 10; r++)
                     {
                        ...
                        {
                           g.setColor(Color.green);
                           if (board.occupied[r+xclick][yclick] == true  && board.bteam[xclick][yclick] != 11)
                           {
                              end = true;
                              g.setColor(Color.orange);
                           }
                     ...
                     for (int r = 1; r < board.speed[xclick][yclick] + 1 && end == false && xclick - r >= 0; r++)
                     {
                        ...
                        else
                        {
                           ...
                           g.setColor(Color.green);
                           if (board.occupied[xclick-r][yclick] == true && board.bteam[xclick][yclick] != 11)
                           {
                              end = true;
                              g.setColor(Color.orange);
                           }
                     ...
                     for (int r = 1; r < board.speed[xclick][yclick] + 1 &&  end == false && yclick - r >= 0; r++)
                     {
                        ...
                        {
                           g.setColor(Color.green);
                           if (board.occupied[xclick][yclick-r] == true && board.bteam[xclick][yclick] != 11)
                           {
                              end = true;
                              g.setColor(Color.orange);
                           }
         ...
         if(screen == 2)
         {
            ...
            Font MonoFont = new Font("Monospaced",Font.BOLD,75);
            g.setFont(MonoFont);
